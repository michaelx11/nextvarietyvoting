...
var ystart = 70;
var menu_end_x = 280;
var rect_start_x = menu_end_x + 20;
var text_start_x = rect_start_x + 20;
var usable_height = viewportheight - 10 - ystart;
var menu_item_height = usable_height / 3;
var menu_item_y = ystart;
var menu_text_y = ystart + 30;
var menu_image_y = ystart + 40;
//Dynamic Menu
...
//                        .attr("ry", "6")
                        .attr("x", "0")
                        .attr("y", function(d,i) { return (menu_item_y + (i * menu_item_height)); })
                        .attr("height", "" + (menu_item_height - 10))
                        .attr("width", "1")
                        .attr("fill", "white")
//                        .attr("fill", "rgba(0,0,0,.05)")
//                        .attr("stroke", "rgba(99,99,99,1)")
//                        .attr("stroke-width", "2")
        ...
        svg_menu.selectAll(".svg-menu-text")
                ...
                .enter().append("text")
                        ...
                        .attr("fill", "rgba(0,63,71,.7)")
                        .attr("x", "20")
                        .attr("y", function(d,i) { return (menu_text_y + (i * menu_item_height)); })
                        .attr("text-anchor", "start")
                        .text(function(d) { return d.title })
                                .transition()
                                .delay(function(d,i) { return 500 + i * 250 })
        ...
        svg_menu.selectAll("image")
                        .data(json)
                .enter().append("svg:image")
                        .attr("x", "20")
                        .attr("y", function(d,i) { return (menu_image_y + (i * menu_item_height)); })
                        .attr("xlink:href",function(d) {return d.image})
                                .transition()
                                .delay(function(d,i) { return 800 + i * 250 })
                                .attr("width", "" + (menu_end_x - 35))
                                .attr("height", "" + (menu_item_height - 60))
//                        .text(function(d) { return d.title })
//                                .transition()
//                                .duration(500)
//                                .attr("fill", "rgba(255,0,0,1");
...
//        .attr("rx", "6")
        .attr("y", "" + ystart)
        .attr("x", "" + rect_start_x)
        .attr("height", viewportheight - ystart - 20)
        .attr("width", "1")
        .attr("fill", "white")
//        .attr("fill", "rgba(0,0,0,0)")
...
//        .on("click", showMenu)
        .transition()
                ...
                .duration(500)
//                .attr("stroke", "rgba(99,99,99,1)")
                .attr("width", viewportwidth - text_start_x)
                .attr("x", "" + rect_start_x);
...
svg_page.append("text")
        ...
        .attr("y", "" + (ystart + 50))
        .attr("text-anchor", "start")
        .text("Margaret Fuller Neighborhood House")
                .transition()
                .delay(750)
                .duration(500)
                .attr("fill", "rgba(0,63,71,.7)");
...
svg_page.append("foreignObject")
        ...
        .attr("x", "" + text_start_x)
        .attr("y", "" + (ystart + 70))
        .attr("width", viewportwidth - text_start_x - 20)
        .attr("height", "1")
